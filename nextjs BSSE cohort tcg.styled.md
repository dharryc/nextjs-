...
A lightweight, opt-in Trading Card Game (TCG) for the BSSE cohort. The goal is simple: collect cards representing cohort members and teachers, trade or upgrade them, and unlock small rewards through participation.
...
- Chests: earned by completing micro-tasks (attending workshops, helping others). Chests grant 1–3 cards.
